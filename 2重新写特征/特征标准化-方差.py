...
# 读取Excel文件
df = pd.read_excel(r"E:\2大学项目\2重新写特征\879个特征样本\4特征+哈工大\879筛选后4特征+5特征+标签.xlsx",
                   index_col=0, usecols=range(0, 11), nrows=None)


df.columns = ['特征' + str(i + 1) for i in range(10)]  # 将列索引重命名为“特征1”, “特征2”, “特征3”等， 到特征51
# 特征和目标变量分离
...
resultPath1 = r"E:\2大学项目\2重新写特征\879个特征样本\4特征+哈工大\879（4+哈工大）方差标准化.xlsx"
