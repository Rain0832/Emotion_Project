...
# 打开BDF文件
mat_file_name = r'C:\\Users\\23145\\Desktop\\edfreadZip\\s27.mat'
to_save_GSR = r'D:\\Papers\\3. 可穿戴设备项目\\processed_data_1\\s27_GSR.xlsx'
to_save_PPG = r'D:\\Papers\\3. 可穿戴设备项目\\processed_data_2\\s27_PPG.xlsx'
...
uthresh = sigma * np.sqrt(2 * np.log(len(raw_PPG))) #计算阈值
denoised_coeffs = [pywt.threshold(c, value=uthresh, mode='soft') for c in coeffs]   #阈值处理
denoised_signal = pywt.waverec(denoised_coeffs, wavelet)    #得到重构的信号
df_PPG = pd.DataFrame(denoised_signal)
